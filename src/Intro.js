...
<div className="black-fade"></div>    
  ...
  <section className="two" id="layer2" style={{ transform: "translateX(-30)" }}>
      ...
      <div className="layer functions">
            <p>Fabric Layer 2</p>
                      ...
                      <g fill="none" fill-rule="evenodd">
                        ...
                        <path stroke="#9DCA40" d="M33.17 798.75h242.12c1.08 0 1.97-.88 1.97-1.96V672.9c0-1.08-.89-1.96-1.97-1.96h-30.12a1.97 1.97 0 0 1-1.98-1.96v-26.76c0-1.07-.88-1.96-1.97-1.96h-20.87" />
                        <path stroke="#9DCA40" d="M458.48 496.1h9.55c1.09 0 2.6-.63 3.37-1.4l48.23-47.83a5.52 5.52 0 0 1 3.38-1.39h24.26c1.08 0 2.6.63 3.37 1.39l23.26 23.1c.77.76 2.29 1.39 3.37 1.39h111.06c1.09 0 1.97-.88 1.97-1.96v-54.46c0-1.08-.63-2.59-1.4-3.33l-20.35-20.04-2.8-2.76-1.17-1.16a5.52 5.52 0 0 0-3.37-1.39h-11.66a1.97 1.97 0 0 1-1.97-1.96V310.6c0-1.08.88-1.96 1.97-1.96h77.38" />
  ...
  <section className="one" id="layer3" style={{ transform: "translateX(-50)" }}>
    <div className="layer-container">
  ...
  <section className="three" id="layer1" style={{ transform: "translateX(0)" }}>
    <div className="layer-container">
