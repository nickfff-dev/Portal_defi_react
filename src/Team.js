    ...
    render() {
        return (
            ...
            <div className="column">
                ...
                <div className="team-container">
                    <img src="https://portaldefi.com/assets/pictures/eric.png" className="circletag"/>
            ...
            <div className="column">
                <div className="card">
                <div className="team-container">
                    <img src="https://portaldefi.com/assets/pictures/jack.png" className="circletag"/>
            ...
            <div className="column">
                <div className="card">
                <div className="team-container">
                    <img src="https://portaldefi.com/assets/pictures/manoj.png" className="circletag"/>
        ...
        <div className="row">
            <div className="column">
                <div className="card">
                <div className="team-container">
                    <img src="https://portaldefi.com/assets/pictures/alexy.png" className="circletag"/>
          ...
          <div className="column">
            <div className="card">
              <div className="team-container">
                <img src="https://portaldefi.com/assets/pictures/chandra.png" className="circletag"/>
          ...
          <div className="column">
            <div className="card">
              <div className="team-container">
                <img src="https://portaldefi.com/assets/pictures/george.png" className="circletag"/>
        ...
        <div className="row">
            ...
            <div className="column">
              <div className="card">
                <div className="team-container">
                    <img src="https://portaldefi.com/assets/pictures/johnny.png" className="circletag"/>
            ...
            <div className="column">
              <div className="card">
                <div className="team-container">
                    <img src="https://portaldefi.com/assets/pictures/farid.png" className="circletag" />
